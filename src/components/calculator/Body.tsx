...
export function Body({
  ...
  return (
    <div className="grid w-72 grid-cols-4 grid-rows-5 gap-3">
      ...
      <Button onClick={() => dispatch({ type: "INVERT" })} type="light">
        +/-
      </Button>
      <Button onClick={() => dispatch({ type: "PERCENTAGE" })} type="light">
        %
      </Button>
      <Button onClick={() => setOperation("÷")} type="highlighted">
        ÷
      </Button>
      ...
      <Button onClick={() => setOperation("MR")} type="highlighted">
        MR
      </Button>
      <Button onClick={() => setOperation("MC")} type="highlighted">
        MC
      </Button>
      <Button onClick={() => setOperation("^")} type="highlighted">
        ^
